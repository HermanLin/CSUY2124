...
stack question
first expect 1, stack rest of line until reach 1
let 1 pass
look for 2, if not in stack look at line, if not in line, push to stack
when do we stop???
stack must be decreasing stack
if top of stack is not n+1, then NO
